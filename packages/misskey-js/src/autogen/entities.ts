...
export type AdminAccountsBulkRequest = operations['admin___accounts___bulk']['requestBody']['content']['application/json'];
export type AdminAccountsBulkResponse = operations['admin___accounts___bulk']['responses']['200']['content']['application/json'];
