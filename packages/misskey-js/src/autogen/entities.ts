...
export type I2faPasskeyDoneRequest = operations['i___2fa___passkey___done']['requestBody']['content']['application/json'];
export type I2faPasskeyDoneResponse = operations['i___2fa___passkey___done']['responses']['200']['content']['application/json'];
export type I2faPasskeyPasswordLessRequest = operations['i___2fa___passkey___password-less']['requestBody']['content']['application/json'];
export type I2faPasskeyRegisterRequest = operations['i___2fa___passkey___register']['requestBody']['content']['application/json'];
export type I2faPasskeyRegisterResponse = operations['i___2fa___passkey___register']['responses']['200']['content']['application/json'];
export type I2faPasskeyRemoveRequest = operations['i___2fa___passkey___remove']['requestBody']['content']['application/json'];
export type I2faPasskeyUpdateRequest = operations['i___2fa___passkey___update']['requestBody']['content']['application/json'];
export type I2faTotpDoneRequest = operations['i___2fa___totp___done']['requestBody']['content']['application/json'];
export type I2faTotpDoneResponse = operations['i___2fa___totp___done']['responses']['200']['content']['application/json'];
export type I2faTotpRegisterRequest = operations['i___2fa___totp___register']['requestBody']['content']['application/json'];
export type I2faTotpRegisterResponse = operations['i___2fa___totp___register']['responses']['200']['content']['application/json'];
export type I2faTotpRemoveRequest = operations['i___2fa___totp___remove']['requestBody']['content']['application/json'];
