...
export type PageV1 = components['schemas']['PageV1'];
export type PageV2 = components['schemas']['PageV2'];
export type PageBlock = components['schemas']['PageBlock'];
export type PageBlockV1 = components['schemas']['PageBlockV1'];
export type PageBlockV2 = components['schemas']['PageBlockV2'];
