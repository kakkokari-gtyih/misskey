...
<div :class="$style.root">
	<div :class="$style.head">
		...
		<div v-else-if="notification.type === 'reaction:grouped' && notification.note.reactionAcceptance === 'likeOnly'" :class="[$style.icon, $style.icon_reactionGroup]"><i class="ti ti-heart" style="line-height: 1;"></i></div>
