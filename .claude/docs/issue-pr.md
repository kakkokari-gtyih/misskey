...
もし、AI が Issue / Pull Request を起票する場合は、以下の点を遵守すること。これらが守られていない場合、内容の如何にかかわらず起票した Issue や Pull Request が閉じられる。
...
Issue Template に定義されていない Issue のジャンル (Blank Issue で起票しなければならないもの) については、内容理解の観点から人間に起票を委ねるべきである。
...
原則として、Issue を起票せずに Pull Request を送信してはならない。また、
